...
int main(int argc, char* argv[])
{
	...
	unsigned char col[9][3]={ {255,0,255}, {0,200,0}, {0,0,255}/*{127,127,255}*/, {255,0,0},
	...
	Fl_Box *bx_lbl7= new Fl_Box(GCF_W+GCP_W, bx_y-10, LBL_W, 20, "torsion");	bx_lbl7->labelcolor( fl_rgb_color(col[2][0],col[2][1],col[2][2]));	bx_y+=gr1_hgt;
	...
	Fl_Box *bx_lbl6= new Fl_Box(GCF_W+GCP_W, bx_y-20, LBL_W, 60, "Right");	bx_lbl6->labelcolor( fl_rgb_color(col[6][0],col[6][1],col[6][2]));
