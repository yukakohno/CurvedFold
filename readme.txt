...
This source code is the revised version of the 7OSME paper:
...
The operation verification have not been done for all functions after some minor rivisions.
Bugs will be fixed as soon as I find them.
